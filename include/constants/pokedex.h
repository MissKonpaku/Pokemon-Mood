...
//DOOMDEX G1
    ...
    NATIONAL_DEX_MORFAMINE,     
    NATIONAL_DEX_BISORGUE,  
    NATIONAL_DEX_VIRICE,   
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_JUJUBIEL
