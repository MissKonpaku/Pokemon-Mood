...
//DOOMDEX G1
    NATIONAL_DEX_LILICHEN,   
    NATIONAL_DEX_NOBLICHEN,  
    NATIONAL_DEX_MONARCHEN,  
    NATIONAL_DEX_BEEMBER,    
    NATIONAL_DEX_DETOPTERE,  
    NATIONAL_DEX_ACIDOPTE,   
    NATIONAL_DEX_WOOPEEL,    
    NATIONAL_DEX_CRUEEL,     
    NATIONAL_DEX_HORRIFEEL,  
    NATIONAL_DEX_CATERPILE,  
    NATIONAL_DEX_COCAMPER,   
    NATIONAL_DEX_LAMPIPOSA,  
    NATIONAL_DEX_SCARABEBE,  
    NATIONAL_DEX_SCARACIER,  
    NATIONAL_DEX_SCABUTO,    
    NATIONAL_DEX_FUKUNNY,    
    NATIONAL_DEX_USAGUNNY,   
    NATIONAL_DEX_YUKIGORI,   
    NATIONAL_DEX_GRALIBRI,   
    NATIONAL_DEX_STALIBRI,   
    NATIONAL_DEX_ZARDOPIUM,  
    NATIONAL_DEX_STALLA,     
    NATIONAL_DEX_STARLING,   
    NATIONAL_DEX_GLADIVA,    
    NATIONAL_DEX_ZAPEK,      
    NATIONAL_DEX_PIKORAGE,   
    NATIONAL_DEX_COCKALYPSE, 
    NATIONAL_DEX_CAVIACHAT,  
    NATIONAL_DEX_CALIKEAU,   
    NATIONAL_DEX_NAUTICAT,   
    NATIONAL_DEX_PLANKTEUY,  
    NATIONAL_DEX_MELODIE,    
    NATIONAL_DEX_MELODRAME,  
    NATIONAL_DEX_BIPPER,     
    NATIONAL_DEX_COPESPINE,  
    NATIONAL_DEX_COLEANGIOS, 
    NATIONAL_DEX_TAUPETI,    
    NATIONAL_DEX_TAUPASSAGE, 
    NATIONAL_DEX_TAUPERE,    
    NATIONAL_DEX_GERBUZZ,    
    NATIONAL_DEX_TESLANTEN,  
    NATIONAL_DEX_GALEMIMI,   
    NATIONAL_DEX_GALEM,      
    NATIONAL_DEX_WARDELITH,  
    NATIONAL_DEX_GROUNDER,   
    NATIONAL_DEX_SNIFOUY,    
    NATIONAL_DEX_FISTFOUY,   
    NATIONAL_DEX_NEKOFEE,    
    NATIONAL_DEX_PLOUFFY,    
    NATIONAL_DEX_COINQWACK,  
    NATIONAL_DEX_COLBOUEE,   
    NATIONAL_DEX_PLOPETIT,   
    NATIONAL_DEX_BUBULLON,   
    NATIONAL_DEX_HEMOGLEZAR, 
    NATIONAL_DEX_SANGLODON,  
    NATIONAL_DEX_FEUVALIER,  
    NATIONAL_DEX_AGOHENIE,  
    NATIONAL_DEX_KATCHINA,   
    NATIONAL_DEX_ELKATCHINA, 
    NATIONAL_DEX_ALWY,       
    NATIONAL_DEX_VEROPHYLA,  
    NATIONAL_DEX_VERACINA,   
    NATIONAL_DEX_SQUALIL,    
    NATIONAL_DEX_SQUALAVA,   
    NATIONAL_DEX_MAGMALODON, 
    NATIONAL_DEX_MANTAMI,    
    NATIONAL_DEX_TOURBIMANTA,
    NATIONAL_DEX_ANCAT,      
    NATIONAL_DEX_PSALMEURTRI,
    NATIONAL_DEX_CHEEPOUF,   
    NATIONAL_DEX_CHEESETAH,  
    NATIONAL_DEX_KHEPRISUN,  
    NATIONAL_DEX_GESTICOT,  
    NATIONAL_DEX_TERRAKAMI,  
    NATIONAL_DEX_VEROTE,     
    NATIONAL_DEX_ROTTENIA,   
    NATIONAL_DEX_BOH,        
    NATIONAL_DEX_EUARK,      
    NATIONAL_DEX_OHHAERK,    
    NATIONAL_DEX_SLEEPOMPIK, 
    NATIONAL_DEX_OMINOUSLEH, 
    NATIONAL_DEX_MANDELMAN,  
    NATIONAL_DEX_CILANG,     
    NATIONAL_DEX_COMPILEX,   
    NATIONAL_DEX_RESNAKE,    
    NATIONAL_DEX_PYTHAGON,   
    NATIONAL_DEX_FILOURS,    
    NATIONAL_DEX_POUPOURS,   
    NATIONAL_DEX_FORBEAR,    
    NATIONAL_DEX_WIGINI,     
    NATIONAL_DEX_WIGELLE,    
    NATIONAL_DEX_WIGOUDI,    
    NATIONAL_DEX_FLAMANON,   
    NATIONAL_DEX_GUITARE_BLINDE,
    NATIONAL_DEX_PUYOTAN,    
    NATIONAL_DEX_POKI,       
    NATIONAL_DEX_POKIKI,     
    NATIONAL_DEX_POKIKIKI,   
    NATIONAL_DEX_FLINGUN,    
    NATIONAL_DEX_KILLENCIEU, 
    NATIONAL_DEX_FLINKALASH, 
    NATIONAL_DEX_MASKAPPY,   
    NATIONAL_DEX_DEPREMASK,  
    NATIONAL_DEX_FINKFOK,    
    NATIONAL_DEX_LEGZ,       
    NATIONAL_DEX_STOOPID,    
    NATIONAL_DEX_POTIPWET,   
    NATIONAL_DEX_FLOPWETWET, 
    NATIONAL_DEX_BEUBLOP_CUTE,
    NATIONAL_DEX_COCOQUILLE, 
    NATIONAL_DEX_PALMYPINCE, 
    NATIONAL_DEX_MAYSUGEKI,  
    NATIONAL_DEX_COUTEAU,    
    NATIONAL_DEX_ESPALAME,   
    NATIONAL_DEX_SINJI,      
    NATIONAL_DEX_PATABRROOT, 
    NATIONAL_DEX_MERACHAN,   
    NATIONAL_DEX_MERAGAZ,    
    NATIONAL_DEX_DAEMONIX,   
    NATIONAL_DEX_ACHAETHENA, 
    NATIONAL_DEX_INCUBOVRAX, 
    NATIONAL_DEX_PHANTASM,  
    NATIONAL_DEX_SHROOMALICE,
    NATIONAL_DEX_DENKID,     
    NATIONAL_DEX_DENKIGAN,   
    NATIONAL_DEX_JAMUSH,     
    NATIONAL_DEX_MYCELLUM,   
    NATIONAL_DEX_BERMUDINE,  
    NATIONAL_DEX_KHELPIVAL,  
    NATIONAL_DEX_BLOBUSTER,  
    NATIONAL_DEX_DRILLOUP,   
    NATIONAL_DEX_PERCYBORG,  
    NATIONAL_DEX_WICHU,      
    NATIONAL_DEX_INCARNAPOT, 
    NATIONAL_DEX_VASAGE,     
    NATIONAL_DEX_FIGGON,     
    NATIONAL_DEX_SALADRAKE,  
    NATIONAL_DEX_AUBERJAW,   
    NATIONAL_DEX_COLZADON,   
    NATIONAL_DEX_EMPRISM,    
    NATIONAL_DEX_PRISMUNTER, 
    NATIONAL_DEX_OCTONIMBUS, 
    NATIONAL_DEX_OCTORAGE,   
    NATIONAL_DEX_LIMACIDE,   
    NATIONAL_DEX_GLAUGOON,   
    NATIONAL_DEX_PHLOTOXICO, 
    NATIONAL_DEX_WUFUR,      
    NATIONAL_DEX_NUNCHAKOS,  
    NATIONAL_DEX_POLIPOUPON, 
    NATIONAL_DEX_ARMEDUSE,   
    NATIONAL_DEX_MEDERIVE,   
    NATIONAL_DEX_GOUPIPOU,   
    NATIONAL_DEX_MAQUILLARD, 
    NATIONAL_DEX_HINOKAMI,   
    NATIONAL_DEX_MOUCHIPS,   
    NATIONAL_DEX_GIGANILLE,  
    NATIONAL_DEX_PROBELLE,   
    NATIONAL_DEX_POME,       
    NATIONAL_DEX_POMDARPI,   
    NATIONAL_DEX_KEROCORN,   
    NATIONAL_DEX_CROACORN,   
    NATIONAL_DEX_CROAQUILLE, 
    NATIONAL_DEX_CHIMESPRIT, 
    NATIONAL_DEX_INDORMON,   
    NATIONAL_DEX_INVOCAMON,  
    NATIONAL_DEX_SHERURAN,   
    NATIONAL_DEX_SHERUCROC,  
    NATIONAL_DEX_GOTINALVE,  
    NATIONAL_DEX_SYNAPTI,    
    NATIONAL_DEX_GLACYNAPSE, 
    NATIONAL_DEX_TERMALIN,   
    NATIONAL_DEX_TERMITORIAL,
    NATIONAL_DEX_TERBABAIN,  
    NATIONAL_DEX_FOURUGLA,   
    NATIONAL_DEX_YETIDIOT,   
    NATIONAL_DEX_GLAKAME,    
    NATIONAL_DEX_KAMEPHALE,  
    NATIONAL_DEX_MOUMOUTROP, 
    NATIONAL_DEX_TUNDRAGON,  
    NATIONAL_DEX_BLASTAILES, 
    NATIONAL_DEX_WAKYWACOUP, 
    NATIONAL_DEX_METALICA,   
    NATIONAL_DEX_POPCORNE,   
    NATIONAL_DEX_EQUESTRIA,  
    NATIONAL_DEX_PEGAZUR,    
    NATIONAL_DEX_PUTRAVEN,   
    NATIONAL_DEX_NECROVORIS, 
    NATIONAL_DEX_ROCHIERE,   
    NATIONAL_DEX_OSTENSSY,   
    NATIONAL_DEX_RANCOSSOR,  
    NATIONAL_DEX_MOSSEMEROS, 
    NATIONAL_DEX_VEUVOILE,   
    NATIONAL_DEX_JAIMAILLE,  
    NATIONAL_DEX_ARMIS,      
    NATIONAL_DEX_ACCALMITE,  
    NATIONAL_DEX_AXOMINOT,   
    NATIONAL_DEX_AXOLORD,    
    NATIONAL_DEX_PADAMIDON, 
    NATIONAL_DEX_PSYCHOBAT,  
    NATIONAL_DEX_CHIROPSY,   
    NATIONAL_DEX_GYAOON,     
    NATIONAL_DEX_PRIMITRONC,
    NATIONAL_DEX_FILICOLITH, 
    NATIONAL_DEX_LARVAMBRE,  
    NATIONAL_DEX_AGGRESTIK,  
    NATIONAL_DEX_STATISORUS, 
    NATIONAL_DEX_VIRULOX,    
    NATIONAL_DEX_RANSOMITE,  
    NATIONAL_DEX_WORMANES,   
    NATIONAL_DEX_NYMFICHU,   
    NATIONAL_DEX_MEMENTOS,   
    NATIONAL_DEX_APPRENPTI,  
    NATIONAL_DEX_REPTUEUR,   
    NATIONAL_DEX_GARDILISK,  
    NATIONAL_DEX_GLYPHILS,   
    NATIONAL_DEX_PANTOMATA,  
    NATIONAL_DEX_LUMINI,     
    NATIONAL_DEX_PARADEMISE, 
    NATIONAL_DEX_TRISANGEL,  
    NATIONAL_DEX_OLIVIL,     
    NATIONAL_DEX_SERAPALME,  
    NATIONAL_DEX_AFIGAZEL,   
    NATIONAL_DEX_PROTYRA,    
    NATIONAL_DEX_MECAREX,    
    NATIONAL_DEX_OMECATYRA,  
    NATIONAL_DEX_PROGREX, 
    NATIONAL_DEX_CELESTIAL,  
    NATIONAL_DEX_JUJUBIEL, 
};
...
#define POKEMON_SLOTS_NUMBER ((NATIONAL_DEX_JUJUBIEL - NATIONAL_DEX_LILICHEN) + 1)
...
enum {
    ...
    HOENN_DEX_BIPPER,
    HOENN_DEX_COPESPINE,
    HOENN_DEX_COLEANGIOS,
    HOENN_DEX_TAUPETI,
    HOENN_DEX_TAUPASSAGE,
    HOENN_DEX_TAUPERE,
    HOENN_DEX_GERBUZZ,
    HOENN_DEX_TESLANTEN,
    HOENN_DEX_GALEMIMI,
    ...
    HOENN_DEX_PLOPETIT,
    HOENN_DEX_BUBULLON,
    HOENN_DEX_HEMOGLEZAR,
    HOENN_DEX_SANGLODON,
    HOENN_DEX_FEUVALIER,
    HOENN_DEX_AGOHENIE,
    HOENN_DEX_KATCHINA,
    HOENN_DEX_ELKATCHINA,
    HOENN_DEX_ALWY,
    HOENN_DEX_VEROPHYLA,
    HOENN_DEX_VERACINA,
    HOENN_DEX_SQUALIL,
    HOENN_DEX_SQUALAVA,
    HOENN_DEX_MAGMALODON,
    HOENN_DEX_MANTAMI,
    HOENN_DEX_TOURBIMANTA,
    HOENN_DEX_ANCAT,
    HOENN_DEX_PSALMEURTRI,
    HOENN_DEX_CHEEPOUF,
    HOENN_DEX_CHEESETAH,
    HOENN_DEX_KHEPRISUN,
    HOENN_DEX_GESTICOT,
    ...
    HOENN_DEX_EUARK,
    HOENN_DEX_OHHAERK,
    HOENN_DEX_SLEEPOMPIK,
    HOENN_DEX_OMINOUSLEH,
    HOENN_DEX_MANDELMAN,
    HOENN_DEX_CILANG,
    HOENN_DEX_COMPILEX,
    HOENN_DEX_RESNAKE,
    ...
    HOENN_DEX_WIGOUDI,
    HOENN_DEX_FLAMANON,
    HOENN_DEX_GUITARE_BLINDE,
    HOENN_DEX_PUYOTAN,
    HOENN_DEX_POKI,
    HOENN_DEX_POKIKI,
    HOENN_DEX_POKIKIKI,
    HOENN_DEX_FLINGUN,
    HOENN_DEX_KILLENCIEU,
    HOENN_DEX_FLINKALASH,
    HOENN_DEX_MASKAPPY,
    HOENN_DEX_DEPREMASK,
    HOENN_DEX_FINKFOK,
    HOENN_DEX_LEGZ,
    HOENN_DEX_STOOPID,
    HOENN_DEX_POTIPWET,
    HOENN_DEX_FLOPWETWET,
    HOENN_DEX_BEUBLOP_CUTE,
    HOENN_DEX_COCOQUILLE,
    HOENN_DEX_PALMYPINCE,
    HOENN_DEX_MAYSUGEKI,
    HOENN_DEX_COUTEAU,
    HOENN_DEX_ESPALAME,
    HOENN_DEX_SINJI,
    HOENN_DEX_PATABRROOT,
    HOENN_DEX_MERACHAN,
    HOENN_DEX_MERAGAZ,
    HOENN_DEX_DAEMONIX,
    HOENN_DEX_ACHAETHENA,
    HOENN_DEX_INCUBOVRAX,
    HOENN_DEX_PHANTASM,
    HOENN_DEX_SHROOMALICE,
    HOENN_DEX_DENKID,
    HOENN_DEX_DENKIGAN,
    HOENN_DEX_JAMUSH,
    HOENN_DEX_MYCELLUM,
    ...
    HOENN_DEX_COLZADON,
    HOENN_DEX_EMPRISM,
    HOENN_DEX_PRISMUNTER,
    HOENN_DEX_OCTONIMBUS,
    HOENN_DEX_OCTORAGE,
    HOENN_DEX_LIMACIDE,
    HOENN_DEX_GLAUGOON,
    HOENN_DEX_PHLOTOXICO,
    HOENN_DEX_WUFUR,
    HOENN_DEX_NUNCHAKOS,
    HOENN_DEX_POLIPOUPON,
    HOENN_DEX_ARMEDUSE,
    HOENN_DEX_MEDERIVE,
    HOENN_DEX_GOUPIPOU,
    HOENN_DEX_MAQUILLARD,
    HOENN_DEX_HINOKAMI,
    HOENN_DEX_MOUCHIPS,
    HOENN_DEX_GIGANILLE,
    HOENN_DEX_PROBELLE,
    ...
    HOENN_DEX_GOTINALVE,
    HOENN_DEX_SYNAPTI,
    HOENN_DEX_GLACYNAPSE,
    HOENN_DEX_TERMALIN,
    HOENN_DEX_TERMITORIAL,
    HOENN_DEX_TERBABAIN,
    HOENN_DEX_FOURUGLA,
    HOENN_DEX_YETIDIOT,
    HOENN_DEX_GLAKAME,
    HOENN_DEX_KAMEPHALE,
    HOENN_DEX_MOUMOUTROP,
    HOENN_DEX_TUNDRAGON,
    HOENN_DEX_BLASTAILES,
    HOENN_DEX_WAKYWACOUP,
    HOENN_DEX_METALICA,
    HOENN_DEX_POPCORNE,
    HOENN_DEX_EQUESTRIA,
    HOENN_DEX_PEGAZUR,
    HOENN_DEX_PUTRAVEN,
    HOENN_DEX_NECROVORIS,
    HOENN_DEX_ROCHIERE,
    HOENN_DEX_OSTENSSY,
    HOENN_DEX_RANCOSSOR,
    HOENN_DEX_MOSSEMEROS,
    HOENN_DEX_VEUVOILE,
    HOENN_DEX_JAIMAILLE,
    HOENN_DEX_ARMIS,
    HOENN_DEX_ACCALMITE,
    ...
    HOENN_DEX_CHIROPSY,
    HOENN_DEX_GYAOON,
    HOENN_DEX_PRIMITRONC,
    HOENN_DEX_FILICOLITH,
    HOENN_DEX_LARVAMBRE,
    HOENN_DEX_AGGRESTIK,
    HOENN_DEX_STATISORUS,
    HOENN_DEX_VIRULOX,
    HOENN_DEX_RANSOMITE,
    HOENN_DEX_WORMANES,
    HOENN_DEX_NYMFICHU,
...
#define HOENN_DEX_COUNT (HOENN_DEX_JUJUBIEL + 1)
