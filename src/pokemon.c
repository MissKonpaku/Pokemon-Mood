...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(BEEMBER),             
    HOENN_TO_NATIONAL(DETOPTERE),            
    HOENN_TO_NATIONAL(ACIDOPTE),             
    ...
    HOENN_TO_NATIONAL(SCARACIER),        
    HOENN_TO_NATIONAL(SCABUTO),        
    HOENN_TO_NATIONAL(FUKUNNY),        
    HOENN_TO_NATIONAL(USAGUNNY),        
    HOENN_TO_NATIONAL(YUKIGORI),        
    HOENN_TO_NATIONAL(GRALIBRI),        
    HOENN_TO_NATIONAL(STALIBRI),        
    HOENN_TO_NATIONAL(ZARDOPIUM),        
    HOENN_TO_NATIONAL(STALLA),        
    HOENN_TO_NATIONAL(STARLING),        
    HOENN_TO_NATIONAL(GLADIVA),        
    HOENN_TO_NATIONAL(ZAPEK),        
    HOENN_TO_NATIONAL(PIKORAGE),        
    HOENN_TO_NATIONAL(COCKALYPSE),        
    HOENN_TO_NATIONAL(CAVIACHAT),        
    HOENN_TO_NATIONAL(CALIKEAU),        
    HOENN_TO_NATIONAL(NAUTICAT),        
    HOENN_TO_NATIONAL(PLANKTEUY),        
    HOENN_TO_NATIONAL(MELODIE),        
    HOENN_TO_NATIONAL(MELODRAME),        
    HOENN_TO_NATIONAL(BIPPER),        
    HOENN_TO_NATIONAL(COPESPINE),        
    HOENN_TO_NATIONAL(COLEANGIOS),        
    HOENN_TO_NATIONAL(TAUPETI),        
    HOENN_TO_NATIONAL(TAUPASSAGE),        
    HOENN_TO_NATIONAL(TAUPERE),        
    HOENN_TO_NATIONAL(GERBUZZ),        
    HOENN_TO_NATIONAL(TESLANTEN),        
    HOENN_TO_NATIONAL(GALEMIMI),        
    HOENN_TO_NATIONAL(GALEM),        
    HOENN_TO_NATIONAL(WARDELITH),        
    HOENN_TO_NATIONAL(GROUNDER),        
    HOENN_TO_NATIONAL(SNIFOUY),        
    HOENN_TO_NATIONAL(FISTFOUY),        
    HOENN_TO_NATIONAL(NEKOFEE),        
    HOENN_TO_NATIONAL(PLOUFFY),        
    HOENN_TO_NATIONAL(COINQWACK),        
    HOENN_TO_NATIONAL(COLBOUEE),        
    HOENN_TO_NATIONAL(PLOPETIT),        
    HOENN_TO_NATIONAL(BUBULLON),        
    HOENN_TO_NATIONAL(HEMOGLEZAR),        
    HOENN_TO_NATIONAL(SANGLODON),        
    HOENN_TO_NATIONAL(FEUVALIER),        
    HOENN_TO_NATIONAL(AGOHENIE),        
    HOENN_TO_NATIONAL(KATCHINA),        
    HOENN_TO_NATIONAL(ELKATCHINA),        
    HOENN_TO_NATIONAL(ALWY),        
    HOENN_TO_NATIONAL(VEROPHYLA),        
    HOENN_TO_NATIONAL(VERACINA),        
    HOENN_TO_NATIONAL(SQUALIL),        
    HOENN_TO_NATIONAL(SQUALAVA),        
    HOENN_TO_NATIONAL(MAGMALODON),        
    HOENN_TO_NATIONAL(MANTAMI),        
    HOENN_TO_NATIONAL(TOURBIMANTA),        
    HOENN_TO_NATIONAL(ANCAT),        
    HOENN_TO_NATIONAL(PSALMEURTRI),        
    HOENN_TO_NATIONAL(CHEEPOUF),        
    HOENN_TO_NATIONAL(CHEESETAH),        
    HOENN_TO_NATIONAL(KHEPRISUN),        
    HOENN_TO_NATIONAL(GESTICOT),        
    HOENN_TO_NATIONAL(TERRAKAMI),        
    HOENN_TO_NATIONAL(VEROTE),        
    HOENN_TO_NATIONAL(ROTTENIA),        
    HOENN_TO_NATIONAL(BOH),        
    HOENN_TO_NATIONAL(EUARK),        
    HOENN_TO_NATIONAL(OHHAERK),        
    HOENN_TO_NATIONAL(SLEEPOMPIK),        
    HOENN_TO_NATIONAL(OMINOUSLEH),        
    HOENN_TO_NATIONAL(MANDELMAN),        
    HOENN_TO_NATIONAL(CILANG),        
    HOENN_TO_NATIONAL(COMPILEX),        
    HOENN_TO_NATIONAL(SCRIPTILE),        
    HOENN_TO_NATIONAL(PYTHAGON),        
    HOENN_TO_NATIONAL(FILOURS),        
    HOENN_TO_NATIONAL(POUPOURS),        
    HOENN_TO_NATIONAL(FORBEAR),        
    HOENN_TO_NATIONAL(WIGINI),        
    HOENN_TO_NATIONAL(WIGELLE),        
    HOENN_TO_NATIONAL(WIGOUDI),        
    HOENN_TO_NATIONAL(FLAMANON),        
    HOENN_TO_NATIONAL(GUITARE_BLINDE),        
    HOENN_TO_NATIONAL(PUYOTAN),        
    HOENN_TO_NATIONAL(POKI),        
    HOENN_TO_NATIONAL(POKIKI),        
    HOENN_TO_NATIONAL(POKIKIKI),        
    HOENN_TO_NATIONAL(FLINGUN),        
    HOENN_TO_NATIONAL(KILLENCIEU),        
    HOENN_TO_NATIONAL(FLINKALASH),        
    HOENN_TO_NATIONAL(MASKAPPY),        
    HOENN_TO_NATIONAL(DEPREMASK),        
    HOENN_TO_NATIONAL(FINKFOK),        
    HOENN_TO_NATIONAL(LEGZ),        
    HOENN_TO_NATIONAL(STOOPID),        
    HOENN_TO_NATIONAL(POTIPWET),        
    HOENN_TO_NATIONAL(FLOPWETWET),        
    HOENN_TO_NATIONAL(BEUBLOP_CUTE),        
    HOENN_TO_NATIONAL(COCOQUILLE),        
    HOENN_TO_NATIONAL(PALMYPINCE),        
    HOENN_TO_NATIONAL(MAYSUGEKI),        
    HOENN_TO_NATIONAL(COUTEAU),        
    HOENN_TO_NATIONAL(ESPALAME),        
    HOENN_TO_NATIONAL(SINJI),        
    HOENN_TO_NATIONAL(PATABRROOT),        
    HOENN_TO_NATIONAL(MERACHAN),        
    HOENN_TO_NATIONAL(MERAGAZ),        
    HOENN_TO_NATIONAL(DAEMONIX),        
    HOENN_TO_NATIONAL(ACHAETHENA),        
    HOENN_TO_NATIONAL(BEELZEROS),        
    HOENN_TO_NATIONAL(PHANTASM),        
    HOENN_TO_NATIONAL(SHROOMALICE),        
    HOENN_TO_NATIONAL(DENKID),        
    HOENN_TO_NATIONAL(DENKIGAN),        
    HOENN_TO_NATIONAL(JAMUSH),        
    HOENN_TO_NATIONAL(MYCELLUM),        
    HOENN_TO_NATIONAL(BERMUDINE),        
    HOENN_TO_NATIONAL(KHELPIVAL),        
    HOENN_TO_NATIONAL(BLOBUSTER),        
    HOENN_TO_NATIONAL(DRILLOUP),        
    HOENN_TO_NATIONAL(PERCYBORG),        
    HOENN_TO_NATIONAL(WICHU),        
    HOENN_TO_NATIONAL(INCARNAPOT),        
    HOENN_TO_NATIONAL(VASAGE),        
    HOENN_TO_NATIONAL(FIGGON),        
    HOENN_TO_NATIONAL(SALADRAKE),        
    HOENN_TO_NATIONAL(AUBERJAW),        
    HOENN_TO_NATIONAL(COLZADON),        
    HOENN_TO_NATIONAL(EMPRISM),        
    HOENN_TO_NATIONAL(PRISMUNTER),        
    HOENN_TO_NATIONAL(OCTONIMBUS),        
    HOENN_TO_NATIONAL(OCTORAGE),        
    HOENN_TO_NATIONAL(LIMACIDE),        
    HOENN_TO_NATIONAL(GLAUGOON),        
    HOENN_TO_NATIONAL(PHLOTOXICO),        
    HOENN_TO_NATIONAL(WUFUR),        
    HOENN_TO_NATIONAL(NUNCHAKOS),        
    HOENN_TO_NATIONAL(POLIPOUPON),        
    HOENN_TO_NATIONAL(ARMEDUSE),        
    HOENN_TO_NATIONAL(MEDERIVE),        
    HOENN_TO_NATIONAL(GOUPIPOU),        
    HOENN_TO_NATIONAL(MAQUILLARD),        
    HOENN_TO_NATIONAL(HINOKAMI),        
    HOENN_TO_NATIONAL(MOUCHIPS),        
    HOENN_TO_NATIONAL(GIGANILLE),        
    HOENN_TO_NATIONAL(PROBELLE),        
    HOENN_TO_NATIONAL(POME),        
    HOENN_TO_NATIONAL(POMDARPI),        
    HOENN_TO_NATIONAL(KEROCORN),        
    HOENN_TO_NATIONAL(CROACORN),        
    HOENN_TO_NATIONAL(CROAQUILLE),        
    HOENN_TO_NATIONAL(CHIMESPRIT),        
    HOENN_TO_NATIONAL(INDORMON),        
    HOENN_TO_NATIONAL(INVOCAMON),        
    HOENN_TO_NATIONAL(SHERURAN),        
    HOENN_TO_NATIONAL(SHERUCROC),        
    HOENN_TO_NATIONAL(GOTINALVE),        
    HOENN_TO_NATIONAL(SYNAPTI),        
    HOENN_TO_NATIONAL(GLACYNAPSE),        
    HOENN_TO_NATIONAL(TERMALIN),        
    HOENN_TO_NATIONAL(TERMITORIAL),        
    HOENN_TO_NATIONAL(TERBABAIN),        
    HOENN_TO_NATIONAL(FOURUGLA),        
    HOENN_TO_NATIONAL(YETIDIOT),        
    HOENN_TO_NATIONAL(GLAKAME),        
    HOENN_TO_NATIONAL(KAMEPHALE),        
    HOENN_TO_NATIONAL(MOUMOUTROP),        
    HOENN_TO_NATIONAL(TUNDRAGON),        
    HOENN_TO_NATIONAL(BLASTAILES),        
    HOENN_TO_NATIONAL(WAKYWACOUP),        
    HOENN_TO_NATIONAL(METALICA),        
    HOENN_TO_NATIONAL(POPCORNE),        
    HOENN_TO_NATIONAL(EQUESTRIA),        
    HOENN_TO_NATIONAL(PEGAZUR),        
    HOENN_TO_NATIONAL(PUTRAVEN),        
    HOENN_TO_NATIONAL(NECROVORIS),        
    HOENN_TO_NATIONAL(ROCHIERE),        
    HOENN_TO_NATIONAL(OSTENSSY),        
    HOENN_TO_NATIONAL(RANCOSSOR),        
    HOENN_TO_NATIONAL(MOSSEMEROS),        
    HOENN_TO_NATIONAL(VEUVOILE),        
    HOENN_TO_NATIONAL(JAIMAILLE),        
    HOENN_TO_NATIONAL(ARMIS),        
    HOENN_TO_NATIONAL(ACCALMITE),        
    HOENN_TO_NATIONAL(AXOMINOT),        
    HOENN_TO_NATIONAL(AXOLORD),        
    HOENN_TO_NATIONAL(PADAMIDON),        
    HOENN_TO_NATIONAL(PSYCHOBAT),        
    HOENN_TO_NATIONAL(CHIROPSY),        
    HOENN_TO_NATIONAL(GYAOON),        
    HOENN_TO_NATIONAL(PRIMITRONC),        
    HOENN_TO_NATIONAL(FILICOLITH),        
    HOENN_TO_NATIONAL(LARVAMBRE),        
    HOENN_TO_NATIONAL(AGGRESTIK),        
    HOENN_TO_NATIONAL(STATISORUS),        
    HOENN_TO_NATIONAL(VIRULOX),        
    HOENN_TO_NATIONAL(RANSOMITE),        
    HOENN_TO_NATIONAL(WORMANES),        
    HOENN_TO_NATIONAL(NYMFICHU),        
    HOENN_TO_NATIONAL(MEMENTOS),        
    HOENN_TO_NATIONAL(APPRENPTI),        
    HOENN_TO_NATIONAL(REPTUEUR),        
    HOENN_TO_NATIONAL(GARDILISK),        
    HOENN_TO_NATIONAL(GLYPHILS),          
    HOENN_TO_NATIONAL(PANTOMATA),            
    HOENN_TO_NATIONAL(LUMINI),           
    HOENN_TO_NATIONAL(PARADEMISE),        
    HOENN_TO_NATIONAL(TRISANGEL),        
    HOENN_TO_NATIONAL(OLIVIL),        
    HOENN_TO_NATIONAL(SERAPALME),        
    HOENN_TO_NATIONAL(AFIGAZEL),        
    HOENN_TO_NATIONAL(PROTYRA),        
    HOENN_TO_NATIONAL(MECAREX),        
