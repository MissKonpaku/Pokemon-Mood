...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(CHAROSABLE), 
    HOENN_TO_NATIONAL(DUNESTIN),   
    ...
    HOENN_TO_NATIONAL(MAGNIFEET),  
    HOENN_TO_NATIONAL(STOOPID),      
    HOENN_TO_NATIONAL(BEUBLOP),    
    ...
    HOENN_TO_NATIONAL(SHRUMALICE), 
    HOENN_TO_NATIONAL(DENKID),     
    HOENN_TO_NATIONAL(DENKIGAN),   
    HOENN_TO_NATIONAL(JAMUSH),     
    HOENN_TO_NATIONAL(MYCELLUM),   
    HOENN_TO_NATIONAL(MEOWER),     
    HOENN_TO_NATIONAL(CATATION),  
    HOENN_TO_NATIONAL(PHALLION),   
    HOENN_TO_NATIONAL(MERLADY),    
    HOENN_TO_NATIONAL(LASSIREN),   
    HOENN_TO_NATIONAL(WORNYMPH),   
    ...
    HOENN_TO_NATIONAL(CAESABLESS), 
    HOENN_TO_NATIONAL(HAPIDUSE),   
    HOENN_TO_NATIONAL(PERDUSE),    
    HOENN_TO_NATIONAL(MEDERIVE),   
    HOENN_TO_NATIONAL(ILLUFOX),    
    HOENN_TO_NATIONAL(SPERENARD),  
    HOENN_TO_NATIONAL(BISMASHIRA), 
    ...
    HOENN_TO_NATIONAL(BEAUVY),     
    HOENN_TO_NATIONAL(ROSTIER),    
    ...
    HOENN_TO_NATIONAL(TROMPLANTE), 
    HOENN_TO_NATIONAL(PADAMIDON), 
    HOENN_TO_NATIONAL(PSYCHOBAT),
    HOENN_TO_NATIONAL(CHIROPSY), 
    HOENN_TO_NATIONAL(GYAOON),
    HOENN_TO_NATIONAL(COUVETEAU),  
    HOENN_TO_NATIONAL(LOUVERNAL),  
    HOENN_TO_NATIONAL(LARVAMBRE),  
    HOENN_TO_NATIONAL(AGGRAMBRE),  
    HOENN_TO_NATIONAL(ALIGRATOR),  
    ...
    HOENN_TO_NATIONAL(BAGALEVIN),  
    HOENN_TO_NATIONAL(FRAPOISSON), 
    HOENN_TO_NATIONAL(DRACOMBAT),  
    HOENN_TO_NATIONAL(UN),         
    HOENN_TO_NATIONAL(DEUX),       
    HOENN_TO_NATIONAL(TROIS),        
    HOENN_TO_NATIONAL(PROTYRA),    
    HOENN_TO_NATIONAL(MECAREX),    
    HOENN_TO_NATIONAL(OMECATYRA),  
    HOENN_TO_NATIONAL(PROGREX),    
    HOENN_TO_NATIONAL(FABULEUX),   
