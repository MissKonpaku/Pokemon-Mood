...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(MORFAMINE),        
    HOENN_TO_NATIONAL(BISORGUE),        
    HOENN_TO_NATIONAL(VIRICE),        
