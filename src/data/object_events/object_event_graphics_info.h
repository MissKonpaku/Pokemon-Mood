/*POKEMON MOOD*/
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GruntM = { 
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_GRUNT_M,
    ...
    .images = sPicTable_GruntM,
    .affineAnims = gDummySpriteAffineAnimTable,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GruntF = { 
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_GRUNT_F,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
